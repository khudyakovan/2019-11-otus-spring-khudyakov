...
CREATE TABLE tbl_comments (uid bigint(20) NOT NULL AUTO_INCREMENT, book_uid bigint(20) NOT NULL, commentator_uid bigint(20) NOT NULL,comment_text text NOT NULL,comment_date datetime NOT NULL,PRIMARY KEY (uid));
...
alter table tbl_comments add constraint FK_comments_book FOREIGN KEY (book_uid) REFERENCES tbl_books (uid) ON DELETE CASCADE ON UPDATE CASCADE;