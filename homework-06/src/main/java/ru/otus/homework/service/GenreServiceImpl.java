...
public class GenreServiceImpl implements GenreService {
    ...
    public void deleteByUid(long genreUid) {
        genreRepository.deleteByUid(genreUid);
    }

    @Override
    public Genre findByUid(long genreUid) {
        return genreRepository.findByUid(genreUid).orElseThrow(
    ...
    public void insertGenresByBookUid(long bookUid, List<Genre> genres) {
        genreRepository.insertGenresByBookUid(bookUid, genres);
    }

    @Override
    public void editGenresByBookUid(long bookUid, List<Genre> genres) {
        genreRepository.editGenresByBookUid(bookUid, genres);
    }

    @Override
    public void deleteGenresByBookUid(long bookUid, List<Genre> genres) {
        genreRepository.deleteGenresByBookUid(bookUid, genres);
    }
