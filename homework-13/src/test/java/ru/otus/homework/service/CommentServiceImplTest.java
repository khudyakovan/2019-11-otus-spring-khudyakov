...
class CommentServiceImplTest {
    ...
    void setUp() {
        ...
        User user = new User(COMMENTATOR_LOGIN, COMMENTATOR_PASSWORD, "", "");
        Comment comment = new Comment(user, "", new Date());
    ...
    void shouldSave() {
        ...
        assertThat(comment.getUser().getUsername()).isEqualTo(COMMENTATOR_LOGIN);
    }
